...
describe("getBotReply", () => {
  it("should have correct response for George", () => {
    ...
    const expectedReply1 =
      "Well met, George, I am here to help you decide your destiny within the world of Faerun or beyond. Are you familiar with Dungeons and Dragons 5th edition?";
  ...
  it("should have correct response for George, no", () => {
    ...
    const expectedReply2 =
      "A newcomer! Let me explain, Dungeons and Dragons is a roleplaying game that has you act as an adventurer whom you create to play as with a group of friends to overcome challenges set for your group by the game master. The outcome of actions within the game are determined by dice rolls and your characters abilities. We are going to look at what classes from this game might interest you based on your preferences or what sounds cool! Would like to continue determining your fate?";
  ...
  it("should have correct response for George, yes, steel, yes", () => {
    ...
    const expectedReply4 =
      "Rangers are martial experts with a splash of magic. Shoot bows, clash swords, eat magic berries and never get lost.";
    expect(botReply4).toEqual(expectedReply4);
  });
  ...
  it("should have correct response for George, yes, magic, yes", () => {
    ...
    const expectedReply4 =
      "I suggest druid, they are masters of the natural world, they wield powerful magic and can shape-shift into mighty beasts.";
    expect(botReply4).toEqual(expectedReply4);
  });
  ...
  it("should have correct response for George, yes, magic, no", () => {
    ...
    const expectedReply4 =
      "Me neither in honesty, but does the sound of playing music to inspire allies and confound foes please your ears?";
    expect(botReply4).toEqual(expectedReply4);
  });
  ...
  it("should have correct response for George, yes, magic, no, yes", () => {
    ...
    const expectedReply5 =
      "The bard may be to your liking. They strum the grandest tunes enthralling the world to their charismatic whim.";
    expect(botReply5).toEqual(expectedReply5);
  });
  ...
  it("should have correct response for George, yes, steel, no", () => {
    ...
    const expectedReply4 =
      "Perhaps you find intrigue in the creation of magic devices and arcane-technology.";
    expect(botReply4).toEqual(expectedReply4);
  });
  ...
  it("should have correct response for George, yes, magic, no, no", () => {
    ...
    const expectedReply5 =
      "The strumming can definitely get irritating. Perhaps serving a divine purpose for the good of all would suit you?";
    expect(botReply5).toEqual(expectedReply5);
  });
  ...
  it("should have correct response for George, yes, steel, no, yes", () => {
    ...
    const expectedReply5 =
      "Artificers use their brains to solve problems with arcane and steel fusions. (Also explosions). ";
    expect(botReply5).toEqual(expectedReply5);
  });
  ...
  it("should have correct response for George, yes, steel, no, no", () => {
    ...
    const expectedReply5 =
      "Does breaking stuff, getting mad, and being indestructible appeal?";
    expect(botReply5).toEqual(expectedReply5);
  });
  ...
  it("should have correct response for George, yes, magic, no, no, yes", () => {
    ...
    const expectedReply6 =
      "The cleric blasts foes with holy light and closes terrible wounds with a touch.";
  ...
  it("should have correct response for George, yes, magic, no, no, no", () => {
    ...
    const expectedReply6 =
      "If not serving a higher purpose, maybe taking power from a lower place and entering into a pact with a powerful entity could entice you?";
    expect(botReply6).toEqual(expectedReply6);
  });
  ...
  it("should have correct response for George, yes, steel, no, no, yes", () => {
    ...
    const expectedReply6 =
      "The barbarian is unmatched in how durable they are. Prone to surviving meteors being dropped on their heads, which is then followed by them picking the meteor up and beating whatever threw it at them into a bloody mess.";
    expect(botReply6).toEqual(expectedReply6);
  });
  ...
  it("should have correct response for George, yes, magic, no, no, no, yes", () => {
    ...
    const expectedReply7 =
      "Warlocks are eldritch masters who make pacts with otherworldly beings for power. I do know a devil who might be interested in your soul.";
  ...
  it("should have correct response for George, yes, steel, no, no, no, yes", () => {
    ...
    const expectedReply7 =
      "Monks use the serenity and calm to dish out lightning fast whoopings with just their fists. Eventually being able to disrupt their enemies chi, stunning them into easy targets.";
    expect(botReply7).toEqual(expectedReply7);
  });
  ...
  it("should have correct response for George, yes, magic, no, no, no, no, blast", () => {
    ...
    const expectedReply8 =
      "Sorceror is a choice. You get the cool part of wizard (explosions) without all that pesky study. Cheater. No, I am NOT salty.";
  ...
  it("should have correct response for George, yes, magic, no, no, no, no, outsmart", () => {
    ...
    const expectedReply8 =
      "Welcome to being the best. Wizards are archmages who control the world, nothing matches a wizards versatility. If an answer can be found, the wizard can provide it.";
    expect(botReply8).toEqual(expectedReply8);
  });
  ...
  it("should have correct response for George, yes, steel, no, no, no, no, yes", () => {
    ...
    const expectedReply8 =
      "Paladins crusade for their beliefs Unwavering in duty, they smite the wicked, with divine radiance, and charge forward clad in the heaviest of armor.";
    expect(botReply8).toEqual(expectedReply8);
  });
  ...
  it("should have correct response for George, yes, steel, no, no, no, no, no, yes", () => {
    ...
    const expectedReply9 =
      "Rogues dart through the battlefield and coin-purses alike. Never being pinned down. They strike at their foes weak points and dart away.";
  ...
  it("should have correct response for George, yes, steel, no, no, no, no, no, no", () => {
    ...
    const expectedReply9 =
      'The only option left is the fighter. They are considered the most "generic" class, but nothing can truly rival their martial prowess. If something needs killing, nothing can match the fighters ferocity and directness.';
    expect(botReply9).toEqual(expectedReply9);
  });
  ...
  it("should have correct response for Yetan", () => {
    ...
    const expectedReply1 =
      "What a conincidence, or maybe you're me in a different universe? No matter, let us continue deciding your destiny within the world of Faerun or beyond. In your universe are you familiar with Dungeons and Dragons 5th edition?";
    expect(botReply1).toEqual(expectedReply1);
  });
  ...
  // test 39
  it("should have correct response for George, yes, steel, no, yes, yes", () => {
    // Input: George
    const botReply1 = getBotReply("George");
    // Output: Well met, George, I am here to help you decide your destiny within the world of Faerun or beyond. Are you familiar with Dungeons and Dragons 5th edition?
    const expectedReply1 =
    ...
    const botReply6 = getBotReply("yes");
    // Output: Artificers use their brains to solve problems with arcane and steel fusions. (Also explosions).
    const expectedReply6 = `You already got your answer, go on shoo!... Oh alright, I do like your company George. Say 'Timeloop' and you can go again, hopefully we haven't looped too many times.`;
    expect(botReply6).toEqual(expectedReply6);
  });
});
